...
import { ClockFadingIcon, HeadsetIcon, SendIcon, LucideIcon } from "lucide-react";
...
export interface Rating {
    ...
    createdAt: string;
    updatedAt: string;
    product: RatingProductRef;
}

export type ProductCategory = | "Headphones" | "Speakers" | "Watch" | "Earbuds" | "Mouse" | "Decoration" | "Camera" | "Pen" | "Theater" | "Cleaner" | string;
...
export type PaymentMethod = "COD" | "STRIPE" | "CARD" | "PAYPAL";
...
export interface Order {
    ...
    coupon: Coupon | Rating; // dummy data mixes both — see note below
...
export interface Assets {
    ...
    product_img4: ImageSrc;
    product_img5: ImageSrc;
    product_img6: ImageSrc;
    product_img7: ImageSrc;
    product_img8: ImageSrc;
    product_img9: ImageSrc;
    product_img10: ImageSrc;
    product_img11: ImageSrc;
    product_img12: ImageSrc;
    product_img13: ImageSrc;
    product_img14: ImageSrc;
    product_img15: ImageSrc;
    product_img16: ImageSrc;
}
...
export const ourSpecsData: SpecItem[] = [
